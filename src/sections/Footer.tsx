...
export default function Footer() {
    ...
    const socialLinks = [
        { icon: <GithubIcon size={20} />, href: 'https://github.com/PedroNogueira97', label: 'GitHub' },
        { icon: <LinkedinIcon size={20} />, href: 'https://linkedin.com/in/pedronogueiraneto', label: 'LinkedIn' },
